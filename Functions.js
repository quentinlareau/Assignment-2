function Banner(){
  ...
  var keyword = "Q"; //changed text MG
	...
	var denseness = 4;
  // Changed denseness MG
  //pushes dots closer together MG
	...
	var itertot = 40;
  //changed "itertot"
  /* seems to affect speed of dots coming together  MG */
	
	this.initialize = function(canvas_id){
		canvas = document.getElementById(canvas_id);
		context = canvas.getContext('2d');
		/*tried to change this but it produced a blank screen MG */
	...
	var start = function(){
		...
		bgContext.fillStyle = "#DCDCDC";
		bgContext.font = '500px futura';
    /* Changed font and size, more px made less of the letters visible MG */
  ...
  /* Changed this and it seem to make the process repeat faster MG */
	...
	var update = function(){
		...
		itercount++;
		clear();
		for (i = 20; i < parts.length; i++){
	
      /* Changed this 1 and it seemed to deactivate the mousing MG */
      ...
      /*Changed this number from 50 to 100 to 5 to 20, and it affects how many bubbles shoot off MG */
			//Draw the circle
			context.fillStyle = parts[i].c;
			context.beginPath();
			context.arc(parts[i].x2, parts[i].y2, 8 ,0 , Math.PI*2, true);
      /* Changed the zero and made the dots reaallly tiny and diffuse & changed the 4 to an 8 and made the dots bigger MG */
			context.closePath();
	    	context.fill();	
