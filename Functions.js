function Banner(){
  ...
  /* seems to affect speed of dots coming together  MG */
	...
	var start = function(){   bgContext.fillRect(400,50,500,300);
  ...
  /* Changed this and it seem to make the process repeat faster MG */
	...
	var drawCircle = function(x, y){
		...
		parts.push(
			{c: '#' + (Math.random() * 100000 + 10000 | 1).toString(16),
       //this creates the randomly generated color but I can't figure out how to really control it - Q
